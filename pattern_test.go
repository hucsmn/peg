...
func runTest(t *testing.T, data testData) {
...
func TestBasicPatterns(t *testing.T) {
	...
	data := []testData{
		...
		{"a", true, 1, false, ``, ``, Dot},
		{"你好", true, 3, false, ``, ``, Dot},
		{"\xe4\xbd\x20", true, 1, false, ``, ``, Dot}, // "\xe4\xbd\x20" is a bad utf-8 sequence, one byte would be matched.
...
func TestPredicators(t *testing.T) {
	data := []testData{
		...
		{"A", true, 1, false, ``, ``, Seq(Dot, BackI("a"))},
		{"A", false, 0, false, ``, ``, Seq(Dot, BackI("b"))},
		{"A", false, 0, false, ``, ``, Seq(Dot, BackI("ab"))},
		{"A", false, 0, false, ``, ``, Seq(Dot, BackI("aB"))},
		{"A", false, 0, false, ``, ``, Seq(Dot, BackI("Ab"))},
		{"A", false, 0, false, ``, ``, Seq(Dot, BackI("AB"))},
		{"A", false, 0, false, ``, ``, Seq(Dot, BackI("ba"))},
		{"A", false, 0, false, ``, ``, Seq(Dot, BackI("Ba"))},
		{"A", false, 0, false, ``, ``, Seq(Dot, BackI("bA"))},
		{"A", false, 0, false, ``, ``, Seq(Dot, BackI("BA"))},
...
// Tests Q0, Q1, Qn, Q01, Qnn, Qmn, J0, Jn, Jnn, Jmn.
...
// Tests Cgrp, Cname, Check, Inject, Ref, RefBack.
